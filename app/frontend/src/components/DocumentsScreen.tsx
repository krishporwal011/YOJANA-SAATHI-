    ...
    <div className="w-[85%] max-w-[1100px] mx-auto bg-white border border-slate-200 rounded-2xl shadow-xl p-8 my-6">
      ...
      <div className="mt-6">
        ...
        <ul className="space-y-2.5">
          {scheme.documents?.map((d, i) => (
            <li
              key={i}
              className="flex items-center justify-between border border-slate-200 p-3.5 rounded-xl bg-slate-50"
            >
              <div>
                ...
                <div className="text-[11px] text-slate-500">
                  {d.required
                    ? "Mandatory for government verification"
              ...
              <div
                className={`text-xs font-bold ${
                  d.required
                    ? "text-amber-700 bg-amber-100 px-2.5 py-1 rounded-md"
                    : "text-emerald-700 bg-emerald-100 px-2.5 py-1 rounded-md"
                }`}
              >
      ...
      <div className="mt-6 p-5 bg-blue-50/60 border border-blue-100 rounded-2xl">
        ...
        <ol className="list-decimal pl-5 space-y-1.5 text-xs text-blue-950 leading-relaxed font-medium">
          <li>
            Ensure all mandatory documents listed above are ready.
          </li>

          <li>
            Click the button below to visit the official government portal.
          </li>

          <li>
            Submit your application directly on the official portal.
          </li>
        </ol>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-end">
        ...
        <div className="text-right">
          ...
          <a
            ...
            className="px-6 py-2.5 rounded-xl text-xs font-bold shadow-lg hover:brightness-110 transition inline-flex items-center gap-1.5"
          >
          ...
          <div className="text-[10px] text-slate-400 mt-2">
            Yojana Saathi does not collect fees or submit applications
            directly. You will open the official portal.
          </div>
